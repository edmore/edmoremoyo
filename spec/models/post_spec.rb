...
describe Post do
  ...
  describe ".ordered_by" do
    it "should order by particular order parameter" do
      post1 = FactoryGirl.create(:post, :title => "Created First")
      post2 = FactoryGirl.create(:post, :title => "Created Second" , :created_at => Time.current + 1.day, :updated_at => Time.current + 1.day)
  ...
  describe "#body_to_html" do
    it 'should return the body textile text as html' do
      post = FactoryGirl.create(:post, :body => "This is *my* text.")
